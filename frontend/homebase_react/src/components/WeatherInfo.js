...
class WeatherInfo extends React.Component {
    ...
    fetchWeather = (city, country) => {
        axios.get(`http://api.openweathermap.org/data/2.5/weather?q=${city},${country}&units=${units}&appid=${myApiKey}`).then(response => {
            this.setState({
                                        ...
                                        <FormGroup bsPrefix="city-form">
                                            ...
                                            <label htmlFor="city-input" className="city-label"> 
                                                <span className="city-span"> 
                                                    Enter a city  
                                                    <span className="format-example"> (ex: MyCity, US) </span>
                                                </span> 
                                            </label>
                                        </FormGroup>
